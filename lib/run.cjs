...
{
	if (region.cp.fn === region.c6.fn)
	{
		return 'on line ' + region.cp.fn;
	}
	return 'on lines ' + region.cp.fn + ' through ' + region.c6.fn;
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{D: nodeList, w: (len / $elm$core$Array$branchFactor) | 0, z: tail});
			} else {
				...
				F2(
					function (pattern, ignoreCase) {
						return $author$project$Category$RegularExpression(
							{
								el: A2($elm$core$Maybe$withDefault, false, ignoreCase),
								eB: pattern
							});
					}),
...
var $rtfeldman$elm_iso8601_date_strings$DeadEnds$deadEndToString = function (deadend) {
	return $rtfeldman$elm_iso8601_date_strings$DeadEnds$problemToString(deadend.eD) + (' at row ' + ($elm$core$String$fromInt(deadend.eJ) + (', col ' + $elm$core$String$fromInt(deadend.d1))));
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {d1: col, e8: contextStack, eD: problem, eJ: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.eJ, s.d1, x, s.l));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{d1: col, l: s0.l, n: s0.n, h: offset, eJ: row, f: s0.f});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.h, s.eJ, s.d1, s);
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{d1: 1, l: s.l, n: s.n, h: s.h + 1, eJ: s.eJ + 1, f: s.f}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{d1: s.d1 + 1, l: s.l, n: s.n, h: newOffset, eJ: s.eJ, f: s.f}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.h, s.eJ, s.d1, s.f);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{d1: newCol, l: s.l, n: s.n, h: newOffset, eJ: newRow, f: s.f});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {d1: col, eD: problem, eJ: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.eJ, p.d1, p.eD);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{d1: 1, l: _List_Nil, n: 1, h: 0, eJ: 1, f: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Conjure$Scalar$defaultCodecs = {
	aw: {
		dg: A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
		c5: function (_v0) {
			var raw = _v0;
...
var $elm$time$Time$toYear = F2(
	function (zone, time) {
		return $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).e_;
	});
...
var $author$project$CustomScalarCodecs$codecs = $author$project$Conjure$Scalar$defineCodecs(
	{
		aw: $author$project$Conjure$Scalar$defaultCodecs.aw,
		ap: {dg: $rtfeldman$elm_iso8601_date_strings$Iso8601$decoder, c5: $rtfeldman$elm_iso8601_date_strings$Iso8601$encode},
		d: {
			dg: A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $elm$json$Json$Decode$string),
			c5: function (_v0) {
				var s = _v0;
				return $elm$json$Json$Encode$string(s);
			}
		},
		aW: {dg: $elm$json$Json$Decode$value, c5: $elm$core$Basics$identity}
	});
		...
		return A3(
			...
			A2(
				...
				function (c) {
					...
					$author$project$Conjure$Scalar$unwrapCodecs($author$project$CustomScalarCodecs$codecs).d)));
	});
...
var $author$project$Settings$decoder = A5(
	...
	F4(
		function (binSize, groupBy, pat, reportUnmatched) {
			return {dZ: binSize, fh: groupBy, fC: pat, fH: reportUnmatched};
		}),
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {aV: charsProcessed, bw: hash, aC: seed, ci: shift};
	});
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$finalize = function (data) {
	var acc = (!(!data.bw)) ? (data.aC ^ A2(
		...
		A2(
			...
			15,
			A2($dillonkearns$elm_graphql$Graphql$Document$Hash$multiplyBy, $dillonkearns$elm_graphql$Graphql$Document$Hash$c1, data.bw)))) : data.aC;
	var h0 = acc ^ data.aV;
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$hashFold = F2(
	function (c, data) {
		var res = data.bw | ((255 & $elm$core$Char$toCode(c)) << data.ci);
		var _v0 = data.ci;
		if (_v0 === 24) {
			return {
				aV: data.aV + 1,
			...
			return {aV: data.aV + 1, bw: res, aC: data.aC, ci: data.ci + 8};
		}
	});
	...
	return A2(
		...
		function () {
			if (!field.$) {
				...
				var typeString = field.a.fS;
				var fieldName = field.a.ea;
				var _arguments = field.b;
...
var $author$project$Conjure$Query$measures = F2(
	function (fillInOptionals____, object____) {
		var filledInOptionals____ = fillInOptionals____(
			{a: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, X: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		var optionalArgs____ = A2(
			...
			_List_fromArray(
				[
					...
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$optional, 'nameCont', filledInOptionals____.X, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)
				]));
		return A4(
...
var $author$project$Conjure$Object$Measure$id = A4(
	...
	'id',
	_List_Nil,
	$author$project$Conjure$Scalar$unwrapCodecs($author$project$CustomScalarCodecs$codecs).d.dg);
...
var $author$project$Conjure$Enum$MeasureType$decoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Conjure$Object$Measure$measureType = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Enum.MeasureType.MeasureType', 'measureType', _List_Nil, $author$project$Conjure$Enum$MeasureType$decoder);
var $author$project$Conjure$Object$Measure$name = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'name', _List_Nil, $elm$json$Json$Decode$string);
var $author$project$Conjure$Object$Measure$position = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Float', 'position', _List_Nil, $elm$json$Json$Decode$float);
...
var $author$project$Authorization$addHeaders = function (_v0) {
	var pat = _v0;
	return A2($dillonkearns$elm_graphql$Graphql$Http$withHeader, 'Authorization', 'Bearer ' + pat);
};
...
var $author$project$Conjure$errorToString = function (e) {
	if (!e.$) {
		...
		switch (e.a.$) {
			...
			case 3:
				var _v3 = e.a;
				var statusCode = _v3.a.fM;
				var statusText = _v3.a.fN;
				return A2(
					$elm$core$String$join,
					'\n',
					_List_fromArray(
...
var $dillonkearns$elm_graphql$Graphql$Http$queryRequest = F2(
	function (baseUrl, query) {
		return {
			c_: baseUrl,
			dh: A2($dillonkearns$elm_graphql$Graphql$Http$Query, $elm$core$Maybe$Nothing, query),
			bc: $dillonkearns$elm_graphql$Graphql$Document$decoder(query),
			J: _List_Nil,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{e0: false, aq: r.aq, bc: r.bc, J: r.J, at: r.at, P: r.P, eV: r.eV, ac: r.ac}));
};
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{e0: true, aq: r.aq, bc: r.bc, J: r.J, at: r.at, P: r.P, eV: r.eV, ac: r.ac}));
};
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{D: nodeList, w: nodeListSize, z: jsArray});
			} else {
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {fi: index, fp: match, Y: number, fO: submatches};
	});
...
var $j_maas$elm_ordered_containers$OrderedDict$empty = {t: $elm$core$Dict$empty, E: _List_Nil};
var $j_maas$elm_ordered_containers$OrderedDict$get = F2(
	function (key, _v0) {
		var orderedDict = _v0;
		return A2($elm$core$Dict$get, key, orderedDict.t);
	});
...
var $j_maas$elm_ordered_containers$OrderedDict$insert = F3(
	function (key, value, _v0) {
		var orderedDict = _v0;
		var filteredOrder = A2($elm$core$Dict$member, key, orderedDict.t) ? A2(
			$elm$core$List$filter,
			function (k) {
				return !_Utils_eq(k, key);
			},
			orderedDict.E) : orderedDict.E;
		var newOrder = _Utils_ap(
			filteredOrder,
			_List_fromArray(
				[key]));
		return {
			t: A3($elm$core$Dict$insert, key, value, orderedDict.t),
			E: newOrder
		};
	});
var $j_maas$elm_ordered_containers$OrderedDict$remove = F2(
	function (key, _v0) {
		var orderedDict = _v0;
		return {
			t: A2($elm$core$Dict$remove, key, orderedDict.t),
			E: A2($elm$core$Dict$member, key, orderedDict.t) ? A2(
				$elm$core$List$filter,
				function (k) {
					return !_Utils_eq(k, key);
				},
...
var $j_maas$elm_ordered_containers$OrderedDict$update = F3(
	function (key, alter, original) {
		...
		var _v0 = A2($elm$core$Dict$get, key, orderedDict.t);
		if (!_v0.$) {
			var oldItem = _v0.a;
			var _v1 = alter(
	...
	function (forceMethod, url, queryParams, maybeOperationName, queryDocument) {
		...
		if (_Utils_eq(
			...
			return {
				...
				at: 1,
				ac: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, queryParams, url)
			};
		} else {
			return {aq: $elm$http$Http$emptyBody, at: 0, ac: urlForGetRequest};
		}
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$GraphqlError$GraphqlError = F3(
	function (message, locations, details) {
		return {dh: details, fo: locations, fq: message};
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$toReadyRequest = function (_v0) {
	...
	if (!_v1.$) {
		...
		var queryRequestDetails = A5(
			...
			querySelectionSet);
		return {
			aq: queryRequestDetails.aq,
			dg: $dillonkearns$elm_graphql$Graphql$Http$decoderOrError(request.bc),
			J: request.J,
			at: function () {
				var _v2 = queryRequestDetails.at;
				if (!_v2) {
					return 'GET';
				} else {
					return 'Post';
		...
		return {
			...
			at: 'POST',
			P: request.P,
			ac: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, request.aB, request.c_)
		};
	}
};
...
var $author$project$Bin$Run$init = function (flags) {
	var flagsDecoder = A3(
		...
		F2(
			function (categories, settings) {
				return {ao: categories, N: settings};
			}),
		A2(
			$elm$json$Json$Decode$field,
			'categories',
	...
	if (!_v0.$) {
		var categories = _v0.a.ao;
		var settings = _v0.a.N;
		...
		return _Utils_Tuple2(
			$author$project$Bin$Run$LoadingMeasures(
				{ao: categories, d5: decodeLinks, N: settings}),
			A2($author$project$Conjure$getMeasures, settings.fC, $author$project$Bin$Run$GotKnownMeasures));
	} else {
		var e = _v0.a;
		return _Utils_Tuple2(
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {eE: processes, eT: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.eT);
		if (_v0.$ === 1) {
			return $elm$core$Task$succeed(state);
		} else {
			var taggers = _v0.a;
	...
	return A6(
		...
		F5(
			function (category, app, title, duration, startTime) {
				return {du: app, c$: category, a7: duration, dr: startTime, aa: title};
			}),
		A2(
...
var $author$project$Period$decoder = A3(
	...
	F2(
		function (s, e) {
			return {
				c6: $elm$time$Time$millisToPosix(e),
				cp: $elm$time$Time$millisToPosix(s)
			};
		}),
		...
		var decoder = A3(
			...
			F2(
				function (events, timeSubmitted) {
					return {fd: events, dS: timeSubmitted};
				}),
			A2(
				$elm$json$Json$Decode$field,
				'eventsByPeriod',
	...
	switch (m.$) {
		...
		case 1:
			...
			return $elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A2($author$project$Query$sub, r.ao, $author$project$Bin$Run$GotQueryResults),
						(!_Utils_eq(r.ar, $elm$core$Maybe$Nothing)) ? A2($elm$time$Time$every, 60000, $author$project$Bin$Run$Tick) : $elm$core$Platform$Sub$none
					]));
		default:
			return $elm$core$Platform$Sub$none;
	}
...
var $author$project$Event$sortByDuration = function () {
	var decreasingDuration = F2(
		function (_v0, _v1) {
			var e1 = _v0;
			var e2 = _v1;
			return A2($elm$core$Basics$compare, e2.a7, e1.a7);
		});
...
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationCreateOrUpdateItemMatchItemV2Attributes = F2(
	function (required____, fillOptionals____) {
		var optionals____ = fillOptionals____(
			{dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		return {dW: required____.dW, dE: optionals____.dE, fV: required____.fV};
	});
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationCreateOrUpdateItemV2Attributes = function (required____) {
	return {dY: required____.dY, fp: required____.fp, et: required____.et};
};
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{d0: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, e9: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, fa: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
	return {d0: optionals____.d0, e9: optionals____.e9, fa: optionals____.fa};
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'key',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.dE, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'value',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.fV, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string))
			]));
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'comment',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.aZ, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'timestamp',
				A2(
				...
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input____.bP,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Conjure$InputObject$encodeMeasurementableMetaItemAttributes)))
			]));
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'attribute',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input____.dW))),
				_Utils_Tuple2(
				'key',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.dE, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'value',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input____.fV)))
			]));
};
			...
			[
				...
				$elm$core$Maybe$Just(
					A2(
						...
						$author$project$CustomScalarCodecs$codecs)(input____.et))),
				_Utils_Tuple2(
				'match',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Conjure$InputObject$encodeMeasurementBatchOperationCreateOrUpdateItemMatchItemV2Attributes)(input____.fp))),
				_Utils_Tuple2(
				'attributes',
				$elm$core$Maybe$Just(
					$author$project$Conjure$InputObject$encodeMeasurementAttributes(input____.dY)))
			]));
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'values',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($dillonkearns$elm_graphql$Graphql$Internal$Encode$string)(input____.fW)))
			]));
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'clientMutationId',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.d0, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'createOrUpdate',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input____.e9,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Conjure$InputObject$encodeMeasurementBatchOperationCreateOrUpdateItemV2Attributes))),
				_Utils_Tuple2(
				'destroy',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input____.fa,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Conjure$InputObject$encodeMeasurementBatchOperationDestroyItemV2Attributes)))
			]));
};
...
var $author$project$Conjure$Mutation$measurementBatchOperationsV2 = F2(
	function (requiredArgs____, object____) {
		return A4(
			...
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'input', requiredArgs____.eo, $author$project$Conjure$InputObject$encodeMeasurementBatchOperationsV2MutationInput)
				]),
			object____,
			A2($elm$core$Basics$composeR, $elm$core$Basics$identity, $elm$json$Json$Decode$nullable));
	});
var $author$project$Conjure$Object$MeasurementBatchOperationsV2MutationPayload$success = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'Bool', 'success', _List_Nil, $elm$json$Json$Decode$bool);
...
var $justinmimbs$date$Date$toOrdinalDate = function (_v0) {
	...
	return {
		dL: rd - $justinmimbs$date$Date$daysBeforeYear(y),
		e_: y
	};
};
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.e_, 0, date.dL);
};
...
var $author$project$Conjure$InputObject$buildMeasurementAttributes = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{aZ: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, bP: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, cu: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, fW: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
	return {aZ: optionals____.aZ, bP: optionals____.bP, cu: optionals____.cu, fW: optionals____.fW};
};
var $author$project$Conjure$InputObject$buildMeasurementableMetaItemAttributes = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, fV: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
	return {dE: optionals____.dE, fV: optionals____.fV};
};
...
var $author$project$Event$toMeasurement = F2(
	function (groupBy, e) {
		...
		var category = e.c$;
		var uniqueKeyVal = {
			dE: $author$project$Event$uniqueKey,
			fU: A2($author$project$Event$uniqueVal, groupBy, e)
		};
		return {
			dY: $author$project$Conjure$InputObject$buildMeasurementAttributes(
				function (r) {
					return _Utils_update(
						r,
						{
							aZ: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
								function () {
									if (!groupBy) {
							...
							bP: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
								_List_fromArray(
									[
										...
										function (r_) {
											return _Utils_update(
												r_,
												{
													dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(uniqueKeyVal.dE),
													fV: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(uniqueKeyVal.fU)
												});
										}),
										$author$project$Conjure$InputObject$buildMeasurementableMetaItemAttributes(
										function (r_) {
											return _Utils_update(
												r_,
												{
													dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Event$binKey),
													fV: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
														$author$project$Event$binVal(e))
												});
										})
									])),
							cu: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(startTime),
							fW: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
...
var $author$project$Conjure$measurementWrite = F2(
	function (groupBy, allEvents) {
										...
										[
											...
											function (r) {
												return _Utils_update(
													r,
													{
														dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(key)
													});
											})
										]),
									et: measureId
		...
		return A2(
			...
			{
				eo: $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput(
					function (r) {
						return _Utils_update(
							r,
							{
								d0: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Conjure$clientMutationId),
								e9: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(allUpdates)
							});
					})
			},
			A3(
...
var $dillonkearns$elm_graphql$Graphql$Http$mutationRequest = F2(
	function (baseUrl, mutationSelectionSet) {
		return {
			c_: baseUrl,
			dh: $dillonkearns$elm_graphql$Graphql$Http$Mutation(mutationSelectionSet),
			bc: $dillonkearns$elm_graphql$Graphql$Document$decoder(mutationSelectionSet),
			J: _List_Nil,
			az: $elm$core$Maybe$Nothing,
			aB: _List_Nil,
			P: $elm$core$Maybe$Nothing,
		...
		if (!res.$) {
			...
			var _v1 = A2(
				...
				A2(
					...
					A2(
						$elm$core$Maybe$map,
						$author$project$Link$assignEvents(r.dk),
						$mgold$elm_nonempty_list$List$Nonempty$fromList(
							A2(
			...
			return _Utils_Tuple2(
				_Utils_eq(matched, $elm$core$Maybe$Nothing) ? $author$project$Bin$Run$Running(
					_Utils_update(
						r,
						{
							ar: $elm$core$Maybe$Just(timeSubmitted)
						})) : $author$project$Bin$Run$Running(r),
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							((!r.N.fH) || $elm$core$List$isEmpty(unmatched)) ? $elm$core$Platform$Cmd$none : $author$project$Log$info(
							A2(
								$elm$core$String$join,
								'\n',
								A2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				'start',
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(p.cp))),
				_Utils_Tuple2(
				'end',
				$elm$json$Json$Encode$int(
					$elm$time$Time$posixToMillis(p.c6)))
			]));
};
var $author$project$Period$encodeAsIso8601 = function (_v0) {
	...
	return $elm$json$Json$Encode$string(
		$elm$core$String$concat(
			_List_fromArray(
				[
					$rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(p.cp),
					'/',
					$rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(p.c6)
				])));
};
...
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationDestroyItemV2Attributes = F2(
	function (required____, fillOptionals____) {
		var optionals____ = fillOptionals____(
			{dE: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		return {dW: required____.dW, dE: optionals____.dE, et: required____.et, fW: required____.fW};
	});
			...
			A2(
				...
				function (m) {
					return A2(
						...
						{
							dW: 'meta',
							et: $author$project$Measure$getId(m),
							fW: allEras
						},
						function (r) {
							return _Utils_update(
				...
				eo: $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput(
					function (r) {
						return _Utils_update(
							...
							{
								d0: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Conjure$clientMutationId),
								fa: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(allDeletions)
							});
					})
			},
			A3(
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.e_ - 1)) + ($justinmimbs$date$Date$monthToNumber(date.eu) - 1)) + n;
	...
	function (binSize, endOfPeriod, now) {
		...
		var periodsSinceLast = $jjant$unwrap$Unwrap$maybe(
			function (minuteDiff) {
				...
				A4($justinmimbs$time_extra$Time$Extra$diff, 13, $elm$time$Time$utc, endOfPeriod, latestPeriod.cp)));
...
var $author$project$Bin$Run$rewriteEventsSinceStartOfDay = F3(
	function (r, zone, now) {
		var _v0 = A3($author$project$Period$sinceStartOfDay, r.N.dZ, zone, now);
		if (!_v0.$) {
			var eras = _v0.a.fc;
			var periods = _v0.a.fD;
			return _Utils_Tuple2(
				$author$project$Bin$Run$Running(r),
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							...
							A2(
								...
								$elm$core$Result$map(
									function (_v1) {
										return {ed: periods, dS: now};
									})),
							A2($mgold$elm_nonempty_list$List$Nonempty$map, $author$project$Link$to, r.dk),
							eras)
						])));
		} else {
			return _Utils_Tuple2(
...
var $author$project$Bin$Run$startProgram = F2(
	function (_v0, res) {
		var categories = _v0.ao;
		var decodeLinks = _v0.d5;
		var settings = _v0.N;
		if (!res.$) {
			if (!res.a.b) {
				return _Utils_Tuple2(
				...
				if (!_v3.$) {
					...
					return _Utils_Tuple2(
						$author$project$Bin$Run$Running(
							{ao: categories, ar: $elm$core$Maybe$Nothing, dk: links, N: settings}),
						A2(
								...
								$elm$core$Platform$Cmd$batch(
									_List_fromArray(
										[
											...
											A4($author$project$Query$put, r.N, r.ao, timeSubmitted, forPeriods)
										])));
						} else {
							var e = res.a;
							return _Utils_Tuple2(
									...
									$elm$core$String$concat(
										_List_fromArray(
											[
												...
												_Utils_eq(r.ar, $elm$core$Maybe$Nothing) ? '\nWatching for new events...' : ''
											]))));
						} else {
							var e = res.a;
							return _Utils_Tuple2(
					...
					default:
						...
						return _Utils_Tuple2(
							...
							A3(
								...
								A3($author$project$Query$put, r.N, r.ao, now),
								A2(
									$elm$core$Maybe$andThen,
									function (lastWrite) {
										return A3($author$project$Period$sinceLastCompleteAt, r.N.dZ, lastWrite, now);
									},
									r.ar)));
				}
			default:
...
var $author$project$Bin$Run$main = $elm$core$Platform$worker(
	{fj: $author$project$Bin$Run$init, fP: $author$project$Bin$Run$subscriptions, fT: $author$project$Bin$Run$update});
