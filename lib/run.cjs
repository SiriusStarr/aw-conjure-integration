...
var $author$project$Conjure$Scalar$defaultCodecs = {
	dT: {
		cf: A2($elm$json$Json$Decode$map, $elm$core$Basics$identity, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
		b5: function (_v0) {
			var raw = _v0;
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$finalize = function (data) {
	var acc = (!(!data.aW)) ? (data.ae ^ A2(
		...
		A2(
			...
			15,
			A2($dillonkearns$elm_graphql$Graphql$Document$Hash$multiplyBy, $dillonkearns$elm_graphql$Graphql$Document$Hash$c1, data.aW)))) : data.ae;
	var h0 = acc ^ data.aw;
	...
	function (c, data) {
		...
		if (_v0 === 24) {
			return {
				aw: data.aw + 1,
				aW: 0,
				ae: A2($dillonkearns$elm_graphql$Graphql$Document$Hash$mix, data.ae, res),
				bv: 0
			};
		} else {
...
var $author$project$Conjure$Query$measures = F2(
	function (fillInOptionals____, object____) {
		var filledInOptionals____ = fillInOptionals____(
			{a: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, I: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
		var optionalArgs____ = A2(
			...
			_List_fromArray(
				[
					...
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$optional, 'nameCont', filledInOptionals____.I, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)
				]));
		return A4(
...
var $dillonkearns$elm_graphql$Graphql$Http$queryRequest = F2(
	function (baseUrl, query) {
		return {
			b1: baseUrl,
			cg: A2($dillonkearns$elm_graphql$Graphql$Http$Query, $elm$core$Maybe$Nothing, query),
	...
	function (forceMethod, url, queryParams, maybeOperationName, queryDocument) {
		...
		if (_Utils_eq(
			...
			return {
				...
				X: 1,
				O: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, queryParams, url)
			};
		} else {
...
var $dillonkearns$elm_graphql$Graphql$Http$toReadyRequest = function (_v0) {
	...
	if (!_v1.$) {
		...
		return {
			...
			cf: $dillonkearns$elm_graphql$Graphql$Http$decoderOrError(request.aJ),
			y: request.y,
			X: function () {
		...
		return {
			...
			X: 'POST',
			C: request.C,
			O: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, request.ad, request.b1)
		};
	}
};
...
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationCreateOrUpdateItemMatchItemV2Attributes = F2(
	function (required____, fillOptionals____) {
		var optionals____ = fillOptionals____(
			{cy: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
...
var $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{cU: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, dW: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, dX: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'key',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input____.cy, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'value',
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'value',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$string(input____.eA)))
			]));
};
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'match',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Conjure$InputObject$encodeMeasurementBatchOperationCreateOrUpdateItemMatchItemV2Attributes)(input____.d7))),
				_Utils_Tuple2(
				'attributes',
				$elm$core$Maybe$Just(
	...
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'values',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($dillonkearns$elm_graphql$Graphql$Internal$Encode$string)(input____.eB)))
			]));
};
...
var $author$project$Conjure$Mutation$measurementBatchOperationsV2 = F2(
	function (requiredArgs____, object____) {
		return A4(
			...
			_List_fromArray(
				[
					A3($dillonkearns$elm_graphql$Graphql$Internal$Builder$Argument$required, 'input', requiredArgs____.de, $author$project$Conjure$InputObject$encodeMeasurementBatchOperationsV2MutationInput)
				]),
			object____,
...
var $author$project$Conjure$InputObject$buildMeasurementAttributes = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{az: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, a5: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, bB: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, eB: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
...
var $author$project$Conjure$InputObject$buildMeasurementableMetaItemAttributes = function (fillOptionals____) {
	var optionals____ = fillOptionals____(
		{cy: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent, eA: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Absent});
				...
				function (r) {
					return _Utils_update(
						r,
						{
							...
							a5: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
								_List_fromArray(
									[
										...
										function (r_) {
											return _Utils_update(
												r_,
												{
													cy: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(uniqueKeyVal.cy),
													eA: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(uniqueKeyVal.ez)
												});
										}),
										$author$project$Conjure$InputObject$buildMeasurementableMetaItemAttributes(
										function (r_) {
											return _Utils_update(
												r_,
												{
													cy: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Event$binKey),
													eA: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
														$author$project$Event$binVal(e))
												});
										})
									])),
							bB: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(startTime),
							eB: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											_Utils_Tuple2(
										...
										[
											...
											function (r) {
												return _Utils_update(
													r,
													{
														cy: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(key)
													});
											})
										]),
									dj: measureId
				...
				de: $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput(
					function (r) {
						return _Utils_update(
							r,
							{
								cU: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Conjure$clientMutationId),
								dW: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(allUpdates)
							});
					})
			},
			A3(
...
var $dillonkearns$elm_graphql$Graphql$Http$mutationRequest = F2(
	function (baseUrl, mutationSelectionSet) {
		return {
			b1: baseUrl,
			cg: $dillonkearns$elm_graphql$Graphql$Http$Mutation(mutationSelectionSet),
				...
				de: $author$project$Conjure$InputObject$buildMeasurementBatchOperationsV2MutationInput(
					function (r) {
						return _Utils_update(
							...
							{
								cU: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present($author$project$Conjure$clientMutationId),
								dX: $dillonkearns$elm_graphql$Graphql$OptionalArgument$Present(allDeletions)
							});
					})
			},
			A3(
